  ...
  try {
    ...
    for (const cat of categories) {
      ...
      const meta = DEFAULT_METADATA[nameKey] || {
        ...
        square_image_url: cat.imageUrl || 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=500',
        landscape_image_url: cat.hero_image_url || 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=1000',
        icon_name: 'shirt',
        accent_color: '#D4A02E',
        bg_tint: '#FAF6E8',
      };

      const sqImg = cat.square_image_url || cat.imageUrl || meta.square_image_url;
      const landImg = cat.landscape_image_url || cat.hero_image_url || meta.landscape_image_url;
