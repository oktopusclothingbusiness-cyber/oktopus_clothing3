...
async function testCategoryAnimation() {
  console.log('🧪 Starting Category Splash Animation Video API Test...');
  ...
  try {
    ...
    console.log(`\n1️⃣ Testing existing categories retrieval: Found ${categories.length} categories.`);
    ...
    console.log('   ✅ Key presence check PASSED.');

    // 2. Test URL Validator
    console.log('\n2️⃣ Testing URL validation helper:');
    const validUrls = [
    ...
    console.log('   ✅ URL validator correctly validated allowed and rejected invalid formats.');

    // 3. Test Inserting a category with animation_video_url
    console.log('\n3️⃣ Testing Category Creation with animation_video_url:');
    ...
    console.log('   ✅ Insert and formatted retrieval with animation_video_url PASSED.');

    // 4. Test Updating the Category Animation URL
    console.log('\n4️⃣ Testing Category Update (PUT simulation):');
    ...
    console.log('   ✅ Category update with updated animation_video_url PASSED.');

    // 5. Test clearing animation URL
    console.log('\n5️⃣ Testing Clearing animation_video_url:');
    await categoriesCollection.updateOne(
      { _id: createdId },
      {
        $set: {
    ...
    console.log('   ✅ Clearing animation_video_url PASSED.');
